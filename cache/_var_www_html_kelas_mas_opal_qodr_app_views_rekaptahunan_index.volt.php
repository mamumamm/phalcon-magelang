...
<script>
    ...
    function show_data_pengeluaran(Tahun) {
        ...
        $.ajax({
            method: "POST",
            dataType: "json",
            url: "<?= $this->url->get('Rekapharian/getViewPengeluaran') ?>/" + Tahun,
    ...
    function show_data_pemasukan(Hari) {
        ...
        $.ajax({
            method: "POST",
            dataType: "json",
            url: "<?= $this->url->get('Rekapharian/getViewPemasukan') ?>/" + Tahun,
            data: $('form.addUser').serialize(),
            success: function(response) {
                var trHTML = '';
    ...
    function show_data_penghasilan(tahun_cair) {
        ...
        $.ajax({
            method: "POST",
            dataType: "json",
            url: "<?= $this->url->get('Rekapharian/getViewPenghasilan') ?>/" + tahun_cair,
            data: $('form.addUser').serialize(),
            success: function(response) {
                var trHTML = '';
                trHTML +=
