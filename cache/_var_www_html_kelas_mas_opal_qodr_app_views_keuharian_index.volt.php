...
function addKeuHarian() {
  $.ajax({
      method: "POST",
      dataType: "json",
      url: "<?= $this->url->get('keuharian/addKeuharian') ?>",
...
function send_data_edit(id) {
  ...
  $.ajax({
      method: "POST",
      dataType: "json",
      url: "<?= $this->url->get('Keuharian/getData') ?>/" + id,
      data: $('form.addKeuHarian').serialize(),
      success: function(res) {
...
function editKeuHarian() {
  $.ajax({
      method: "POST",
      dataType: "json",
      url: "<?= $this->url->get('Keuharian/editKeuharian') ?>",
      data: $('form.addKeuHarian').serialize(),
      success: function(res) {
          new PNotify({
              title: res.title,
...
function deleteKeuHarian() {
  $.ajax({
      method: "POST",
      dataType: "json",
      url: "<?= $this->url->get('Keuharian/deleteKeuharian') ?>",
...
function listKeuHarian(){
  $.ajax({
    method: "GET",
    url: "<?= $this->url->get('Keuharian/listKeuHarian') ?>",
    dataType: "html",
    success: function(res){
