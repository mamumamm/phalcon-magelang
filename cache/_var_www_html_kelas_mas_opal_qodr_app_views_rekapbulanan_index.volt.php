...
function show_data_pengeluaran(Bulan) {
    ...
    $.ajax({
        method: "POST",
        dataType: "json",
        url: "<?= $this->url->get('Rekapbulanan/getViewPengeluaran') ?>/" + Bulan,
...
function show_data_pemasukan(Bulan) {
    ...
    $.ajax({
        method: "POST",
        dataType: "json",
        url: "<?= $this->url->get('Rekapbulanan/getViewPemasukan') ?>/" + Bulan,
        data: $('form.addUser').serialize(),
        success: function(response) {
            var trHTML = '';
            $.each(response, function (i, item) {
...
function show_data_penghasilan(bulan_cair) {
    ...
    $.ajax({
        method: "POST",
        dataType: "json",
        url: "<?= $this->url->get('Rekapbulanan/getViewPenghasilan') ?>/" + bulan_cair,
        data: $('form.addUser').serialize(),
        success: function(response) {
            var trHTML = '';
            $.each(response, function (i, item) {
